...
// import 'package:phoenix/src/beginning/utilities/download/format.dart';
...
//   Future<String> fetchAlbumId(String url) async {
//     final HttpClient httpClient = HttpClient();
//     httpClient.badCertificateCallback =
//         (X509Certificate cert, String host, int port) => Platform.isAndroid;
//     final IOClient myClient = IOClient(httpClient);
//     String body =
//         (await myClient.get(Uri.parse(url), headers: {'Accept': '*/*'}))
//             .body
//             .toString();
//     try {
//       return body.split("\"album_id\":\"")[1].split('"')[0];
//     } catch (e) {
//       return body.split("\"page_id\",\"")[1].split("\",\"")[0];
//     }
//   }
...
//       // debugPrint(getMain.toString(), wrapWidth: 1024);
...
//       final dedicatedResponseList = getMain['dedicated_artist_playlist'];
//       // print("everything i did");
//       // print(dedicatedResponseList);
//       final featuredResponseList = getMain['featured_artist_playlist'];
//       final similarArtistsResponseList = getMain['similarArtists'];
...
//   Future<String> fetchPlaylistId(url) async {
//     final HttpClient httpClient = HttpClient();
//     httpClient.badCertificateCallback =
//         (X509Certificate cert, String host, int port) => Platform.isAndroid;
//     final IOClient myClient = IOClient(httpClient);
...
//             .toString();
//     try {
//       return body.split("\"type\":\"playlist\",\"id\":\"")[1].split('"')[0];
//     } catch (e) {
//       return body.split("\"page_id\",\"")[1].split("\",\"")[0];
//     }
//   }
...
//     final String params = '${endpoints["lyrics"]}&lyrics_id=$songId';
//     try {
//       final res = await getResponse(params);
//       if (res.statusCode == 200) {
//         return (json.decode(res.body)['lyrics']);
//       }
//     } catch (e) {
//       log(e.toString());
//     }
